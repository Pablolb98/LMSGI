...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<html>
			...
			<body>
				<div style="width:1000px; margin: 0 auto;">
					<h1 align="center"><xsl:value-of select="equipo[@tipo='Local']/@nombre"/> - <xsl:value-of select="equipo[@tipo='Visitante']/@nombre"/></h1>
				</div>
				<xsl:call-template name="tablaJugadores"/>
				<br/>
				<xsl:call-template name="cancha"></xsl:call-template>
				<br/>
				<xsl:call-template name="historico"></xsl:call-template>
	...
	<xsl:template name="cancha">
		<table style="background: url('{/partidoBaloncesto/pista}') no-repeat">
